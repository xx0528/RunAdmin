  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="落地页" min-width="200" prop="mainPage" />
    ...
    >
      <div style="height:60vh;overflow:auto;padding:0 12px;">
        <el-form ref="userForm" :rules="rules" :model="userInfo" label-width="80px">
          ...
          <el-form-item label="落地页" prop="mainPage">
            <el-input v-model="userInfo.mainPage" />
          </el-form-item>
...
const rules = ref({
  ...
  mainPage: [
    { required: true, message: '请输入主落地页', trigger: 'blur' }
  ],
  phone: [
